...
class LinkedList(object):
    ...
    def length(self):
        ...
        Best and worst case running time: O(1) Always, instantly accesses the size."""
    ...
    def get_at_index(self, index):
        ...
        Best case running time: O(1) when the index is at the head.
        Worst case running time: O(n) when the index is at the tail."""
    ...
    def insert_at_index(self, index, item):
        ...
        raise ValueError if the given index is out of range of the list size.
        Best case running time: O(1) when the linked list is empty, or has an
        index of 0 / the size of the array.
        Worst case running time: O(n) if the index is at the end of the linked list"""
        # Check if the given index is out of range and if so raise an error
        if not (0 <= index <= self.size):
            raise ValueError('List index out of range: {}'.format(index))
        ...
        #Appends at the end of the list
            ...
            node = self.head
            #Loops until the current node is at the index
    ...
    def prepend(self, item):
        ...
        Best and worst case running time: O(1) Instant access to the head."""
        # Create a new node to hold the given item
        new_node = Node(item)
        # Check if this linked list is empty
        if self.is_empty():
    ...
    def replace(self, old_item, new_item):
        ...
        Worst case running time: O(n) if the old_item is at the tail."""
        # TODO: Find the node containing the given old_item and replace its
        # data with new_item, without creating a new node object
        node = self.head
        while node is not None:
            #Checks if we found the item to replace
